(function ($) {
	...
	$(document).ready(function ($) {
		...
		var _grouploop_16 = $('#grouploop-16');
		_grouploop_16
...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		var cookieUse = false;
		if (localStorage.getItem("cookieUse")) {
			cookieUse = localStorage.getItem("cookieUse")
		} else {
			$('#myModal').modal('show');
